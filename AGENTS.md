# AGENTS.md — mosaic-memory-compress 项目规则

> 本文件由全局记忆拆分而来（2026-08-23），项目细节记忆在 **MEMORY.md**（同目录，按需读）。

## 项目是什么
- 无状态对话压缩库，基于遗忘曲线；TS/ESM，v1.0.0，MIT。位于 coding/mosaic-memory-compress，分支 main。
- 上游公开仓库：TuringCorp-net/mosaic-memory-compress。
